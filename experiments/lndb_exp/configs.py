...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=False):
        ...
        self.root_dir = '/mnt/deep-learning/usr/vincentwu/LNDB'
        ...
        self.file_csv_dict = {
            'train_csv': '/home/vincentwu/LNDB/train.csv',
            'val_csv': '/home/vincentwu/LNDB/val.csv',
            'test_csv':'/home/vincentwu/LNDB/test.csv',
        }
        ...
        if self.multi_class:
            self.class_dict = {1: 'GGO', 2: 'semi-solid',  3: 'solid'}  # 0 is background.
        else:
