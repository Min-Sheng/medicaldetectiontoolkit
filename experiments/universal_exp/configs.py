...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=False):
        ...
        self.root_dir = {'cgh': '/mnt/QNAP/home/jenny/CGH_LungNodule', 
                         'lidc': '/mnt/deep-learning/usr/vincentwu/LIDC', 
                         'lndb': '/mnt/deep-learning/usr/vincentwu/LNDB'}
        ...
        self.pp_name = {'cgh': 'CGH_LungNodule_iou1_ALD_pickle', 
                        'lidc': 'pp_norm', 
                        'lndb': 'pp_norm'}
        self.input_df_name = 'info_df.pickle'
        if isinstance(self.root_dir, dict):
            if isinstance(self.pp_name, dict):
                self.pp_data_path = {dataset_name:os.path.join(self.root_dir[dataset_name], self.pp_name[dataset_name]) for dataset_name in self.root_dir.keys()}
            else:
                self.pp_data_path = {dataset_name:os.path.join(self.root_dir[dataset_name], self.pp_name) for dataset_name in self.root_dir.keys()}
        else:
        ...
        self.file_csv_dict = {
            ...
            'lidc':{
                'train_csv': '/mnt/deep-learning/usr/vincentwu/LIDC/train.csv',
                'val_csv': '/mnt/deep-learning/usr/vincentwu/LIDC/val.csv',
                'test_csv':'/mnt/deep-learning/usr/vincentwu/LIDC/test.csv',
                },
            'lndb':{
                'train_csv': '/mnt/deep-learning/usr/vincentwu/LNDB/train.csv',
                'val_csv': '/mnt/deep-learning/usr/vincentwu/LNDB/val.csv',
                'test_csv':'/mnt/deep-learning/usr/vincentwu/LNDB/test.csv',
                },
        }
        ...
        self.scheduling_criterion = 'nodule_ap'
